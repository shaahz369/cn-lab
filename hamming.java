...
class Hamming {
    public static void main(String args[]) {
        ...
        // Introduce error
        System.out.println("Enter position of a bit to alter (0 for no error):");
    ...
    static int[] generateCode(int a[]) {
        ...
        while (Math.pow(2, parity_count) < (a.length + parity_count + 1)) {
            parity_count++;
        }

        int b[] = new int[a.length + parity_count];

        // Insert parity bits as 2 (placeholder)
    ...
    static void receive(int a[], int parity_count) {
        ...
        // Recalculate parity to form syndrome
